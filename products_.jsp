          ...
          <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
            <%for(java.io.File file: files){
              if(!file.isFile()){             
                  ...
                  if(folder.equalsIgnoreCase(pr)){%>
                    <li data-filter=".filter-<%=file.getName()%>" class="filter-active"><a href="products.jsp?tp=Pr&Pr=<%=file.getName()%>"><%=file.getName()%></a></li>
                <%}else{ %>
                    <li data-filter=".filter-<%=file.getName()%>"><a href="products.jsp?tp=Pr&Pr=<%=file.getName()%>"><font color="black"><%=file.getName()%></font></a></li>
      <%          }
              }
          }
      %>
        ...
        <%for(java.io.File file: files){
          if(!file.isFile()){
            String folder = file.getName();
            if(folder.equalsIgnoreCase(pr)){
           //     java.io.File dir2 = new java.io.File("C:/apache-tomcat-9.0.39/webapps/DutaPlafon/products/"+folder+"/");
