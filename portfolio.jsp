    ...
    <section id="projects" class="projects">
      <div class="container" data-aos="fade-up">
        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry"
          ...
          <%
          java.io.File dir = new java.io.File("C:/apache-tomcat-7.0.81/webapps/DutaPlafon/portfolio");
      ...
      %>
        ...
        <%for(java.io.File file: files){
          if(!file.isFile()){
            ...
            java.io.File dir2 = new java.io.File("C:/apache-tomcat-7.0.81/webapps/DutaPlafon/portfolio/"+folder+"/");
            ...
            for(java.io.File image: images){%>
              <div class="col-lg-4 col-md-6 portfolio-item filter-<%=folder%>">
                <div class="portfolio-content h-100">
                  <img src="portfolio/<%=folder%>/<%=image.getName()%>" class="img-fluid" alt="">
                  <div class="portfolio-info">
                    <a href="portfolio/<%=folder%>/<%=image.getName()%>"
